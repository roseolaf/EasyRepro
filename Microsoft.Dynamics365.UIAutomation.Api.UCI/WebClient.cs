...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public class WebClient : BrowserPage
    {
            ...
            Action<LoginRedirectEventArgs> redirectAction)
        {
            ...
            if (online)
            {
                ...
                else
                {
                    ...
                    driver.WaitForElement(By.XPath(Elements.Xpath[Reference.Login.StaySignedIn]), new TimeSpan(0, 0, 5));
...

        {
            ...
            d.WaitForElement(By.Id("passwordInput")).SendKeysWait(args.Password.ToUnsecureString());
...

        {
            ...
            //d.FindElement(By.Id("submitButton"), new TimeSpan(0, 0, 2)).ClickWait();

            //This method expects single sign-on

            Browser.ThinkTime(5000);

            d.WaitForElement(By.XPath("//div[@id=\"mfaGreetingDescription\"]"));

            var AzureMFA = d.FindElement(By.XPath("//a[@id=\"WindowsAzureMultiFactorAuthentication\"]"));
            AzureMFA.ClickWait(true);
        ...
        internal BrowserCommandResult<bool> OpenApp(string appName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions("Open App"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.AppMenuButton]),TimeSpan.FromSeconds(1)))
                {
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.AppMenuButton])).ClickWait();
                    ...
                    driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Application.Shell]));
                    driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapLauncherButton]));
                    driver.WaitForPageToLoad();
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.UCIAppContainer]), TimeSpan.FromSeconds(1)))
                {
        ...
        internal BrowserCommandResult<bool> OpenGroupSubArea(string group, string subarea, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions("Open Group Sub Area"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapLauncherButton]), TimeSpan.FromSeconds(5)))
                {
                    ...
                    if (!expanded)
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapLauncherButton])).ClickWait();
                }

                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SitemapMenuGroup]),
                ...
                subAreaItem.ClickWait(true);

                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Grid.Container]));
                driver.WaitForPageToLoad();
        ...
        internal BrowserCommandResult<bool> OpenSubArea(string area, string subarea, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions("Open Sub Area"), driver =>
            {
                ...
                {
                    navSubAreas[subarea].ClickWait(true);
                    driver.WaitForTransaction();
                ...
                subAreas[subarea].ClickWait(true);
        ...
        public BrowserCommandResult<Dictionary<string, IWebElement>> OpenMenu(int thinkTime = Constants.DefaultThinkTime)
        {
            return this.Execute(GetOptions("Open Menu"), driver =>
            {
                ...
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.AreaButton])).ClickWait();

                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.AreaMenu]),
                                            new TimeSpan(0, 0, 5),
                                            d =>
                                            {
        ...
        public BrowserCommandResult<Dictionary<string, IWebElement>> OpenMenuFallback(string area, int thinkTime = Constants.DefaultThinkTime)
        {
            return this.Execute(GetOptions("Open Menu"), driver =>
            {
                ...
                //Make sure the sitemap-launcher is expanded - 9.1
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapLauncherButton])))
                {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.SitemapSwitcherButton])))
                {
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SitemapSwitcherButton])).ClickWait(true);

                    driver.WaitForTransaction();

                    driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SitemapSwitcherFlyout]),
                        new TimeSpan(0, 0, 2),
                        d =>
                        {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapAreaMoreButton])))
                {
                    bool isVisible = driver.IsVisible(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapAreaMoreButton]));

                    if (isVisible)
                    {
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapAreaMoreButton])).ClickWait();

                        driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.AreaMoreMenu]),
                                               new TimeSpan(0, 0, 2),
                                               d =>
                                               {
        ...
        internal BrowserCommandResult<Dictionary<string, IWebElement>> OpenSubMenu(string subarea, int thinkTime = Constants.DefaultThinkTime)
        {
            return this.Execute(GetOptions($"Open Sub Menu: {subarea}"), driver =>
            {
                ...
                if (!driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Navigation.PinnedSitemapEntity]),TimeSpan.FromSeconds(3)))
                {
                    ...
                    if (isSiteMapLauncherCloseButtonVisible)
                    {
                        ...
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapLauncherCloseButton])).ClickWait();
                    }

                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SiteMapLauncherButton])).ClickWait();

                    var menuContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SubAreaContainer]));
                ...
                else
                {
                    ...
                    driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SubAreaContainer]));
        ...
        internal BrowserCommandResult<bool> OpenSettingsOption(string command, string dataId, int thinkTime = Constants.DefaultThinkTime)
        {
            return this.Execute(GetOptions($"Open " + command + " " + dataId), driver =>
            {
                ...
                {
                    driver.WaitForElement(By.XPath(cmdButtonBar)).ClickWait();

                    Thread.Sleep(1000);

                    driver.SetVisible(By.XPath(cmdLauncher), true);
                    driver.WaitForElement(By.XPath(cmdLauncher));
                }
        ...
        public BrowserCommandResult<bool> OpenGuidedHelp(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.GuidedHelp])).ClickWait();
        ...
        internal BrowserCommandResult<bool> OpenAdminPortal(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Application.Shell]));
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.AdminPortal]))?.ClickWait();
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.AdminPortalButton]))?.ClickWait();
                return true;
            });
        }
        ...
        internal BrowserCommandResult<bool> OpenGlobalSearch(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SearchButton]),
                new TimeSpan(0, 0, 5),
                d => { driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Navigation.SearchButton])).ClickWait(); },
        ...
        internal BrowserCommandResult<bool> ClickQuickLaunchButton(string toolTip, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Navigation.QuickLaunchMenu])).ClickWait();
        ...
        internal BrowserCommandResult<bool> QuickCreate(string entityName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Quick Create: {entityName}"), driver =>
            {
                ...
                //ClickWait the entity name
                entitybutton.ClickWait(true);
        ...
        internal BrowserCommandResult<bool> ConfirmationDialog(bool ClickConfirmButton)
        {
            ...
            return this.Execute(GetOptions($"Confirm or Cancel Confirmation Dialog"), driver =>
            {
                ...
                if (inlineDialog)
                {
                    ...
                    var dialogFooter = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.ConfirmButton]));

                    if (
                        !(dialogFooter?.FindElements(By.XPath(AppElements.Xpath[AppReference.Dialogs.ConfirmButton])).Count >
                          0)) return true;

                    //ClickWait the Confirm or Cancel button
        ...
        internal BrowserCommandResult<bool> AssignDialog(Dialogs.AssignTo to, string userOrTeamName)
        {
            return this.Execute(GetOptions($"Assign to User or Team Dialog"), driver =>
            {
                ...
                if (inlineDialog)
                {
                    ...
                    {
                        //ClickWait the Option to Assign to User Or Team
                        driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.AssignDialogToggle])).ClickWait();

                        var toggleButton = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.AssignDialogToggle]), "Me/UserTeam toggle button unavailable");
                        if (toggleButton.Text == "Me")
                            toggleButton.ClickWait();

                        //Set the User Or Team
                        var userOrTeamField = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldLookup]), "User field unavailable");
                        ...
                        if (userOrTeamField.FindElements(By.TagName("input")).Count > 0)
                        {
                            ...
                            if (input != null)
                            {
                                ...
                                input.SendKeysWait(userOrTeamName, true);
                            }
                        }

                        //Pick the User from the list
                        driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.AssignDialogUserTeamLookupResults]));
        ...
        internal BrowserCommandResult<bool> SwitchProcessDialog(string processToSwitchTo)
        {
            return this.Execute(GetOptions($"Switch Process Dialog"), driver =>
            {
                ...
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.ActiveProcessGridControlContainer]));
        ...
        internal BrowserCommandResult<bool> CloseOpportunityDialog(bool clickOK)
        {
            return this.Execute(GetOptions($"Close Opportunity Dialog"), driver =>
            {
                ...
                if (inlineDialog)
                {
                    ...
                    driver.WaitForElement(By.XPath(xPath),
                        new TimeSpan(0, 0, 5),
                        d => { driver.FindElement(By.XPath(xPath)).ClickWait(); },
        ...
        internal BrowserCommandResult<bool> HandleSaveDialog()
        {
            ...
            return this.Execute(GetOptions($"Validate Save"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.DuplicateDetectionWindowMarker])))
                {
                    if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.DuplicateDetectionGridRows])))
                    {
                        //Select the first record in the grid
                        driver.FindElements(By.XPath(AppElements.Xpath[AppReference.Entity.DuplicateDetectionGridRows]))[0].ClickWait(true);

                        //ClickWait Ignore and Save
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.DuplicateDetectionIgnoreAndSaveButton])).ClickWait(true);
                        driver.WaitForTransaction();
                    }
                }

                //Is it an Error?
                if (driver.ElementExists(By.XPath("//div[contains(@data-id,'errorDialogdialog')]")))
                {
        ...
        internal BrowserCommandResult<bool> ClickCommand(string name, string subname = "", bool moreCommands = false, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"ClickWait Command"), driver =>
            {
                ...
                //Find the button in the CommandBar this needs up to 5 seconds to load
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.CommandBar.Container]),TimeSpan.FromSeconds(10)))
                ...
                {
                    items.FirstOrDefault(x => x.GetAttribute("aria-label").Equals(name, StringComparison.OrdinalIgnoreCase)).ClickWait(true);
                    driver.WaitForTransaction();
                }
                else
                {
                    ...
                    {
                        //ClickWait More Commands
                        items.FirstOrDefault(x => x.GetAttribute("aria-label").Equals("More Commands", StringComparison.OrdinalIgnoreCase)).ClickWait(true);
                        driver.WaitForTransaction();

                        //ClickWait the button
                        if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.CommandBar.Button].Replace("[NAME]", name))))
                        {
                            driver.FindElement(By.XPath(AppElements.Xpath[AppReference.CommandBar.Button].Replace("[NAME]", name))).ClickWait(true);
                            driver.WaitForTransaction();
                        }
                        else
                ...
                {
                    var submenu = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.CommandBar.MoreCommandsMenu]));

                    var subbutton = submenu.FindElements(By.TagName("button")).FirstOrDefault(x => x.Text == subname);

                    if (subbutton != null)
                    {
                        subbutton.ClickWait(true);
                    }
                    else
        ...
        internal BrowserCommandResult<List<string>> GetCommandValues(bool includeMoreCommandsValues = false, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions("Get CommandBar Command Count"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.CommandBar.Container]),TimeSpan.FromSeconds(30)))
                    ribbon = driver.FindElement(By.XPath(AppElements.Xpath[AppReference.CommandBar.Container]));

                if (ribbon == null)
                {
                    if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.CommandBar.ContainerGrid]), TimeSpan.FromSeconds(30)))
                        ribbon = driver.FindElement(By.XPath(AppElements.Xpath[AppReference.CommandBar.ContainerGrid]));
                    else
                        throw new InvalidOperationException("Unable to find the ribbon.");
                }
                ...
                if (includeMoreCommandsValues)
                {
                    ...
                    {
                        //ClickWait More Commands Button
                        commandBarItems.FirstOrDefault(x => x.GetAttribute("aria-label").Equals("More Commands", StringComparison.OrdinalIgnoreCase)).ClickWait(true);
                        driver.WaitForTransaction();
        ...
        public BrowserCommandResult<Dictionary<string, string>> OpenViewPicker(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions("Open View Picker"), driver =>
            {
                ...
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Grid.ViewSelector]),
                    new TimeSpan(0, 0, 20),
                    d => { d.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.ViewSelector])).ClickWait(); },
        ...
        internal BrowserCommandResult<bool> SwitchView(string viewName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Switch View"), driver =>
            {
                ...
                driver.FindElement(By.Id(viewId)).ClickWait();
        ...
        internal BrowserCommandResult<bool> OpenRecord(int index, int thinkTime = Constants.DefaultThinkTime, bool checkRecord = false)
        {
            ...
            {
                var currentindex = 0;
                //var control = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Grid.Container]));
                ...
                foreach (var row in rows)
                {
                    if (!string.IsNullOrEmpty(row.GetAttribute("data-lp-id")))
                    {
                        if (currentindex == index)
                        {
                            ...
                            row.FindElement(By.TagName(tag)).ClickWait();
                            break;
                        }
                ...
                //driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.Form]));
        ...
        internal BrowserCommandResult<bool> Search(string searchCriteria, bool clearByDefault = true, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Grid.QuickFind]));
                ...
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.QuickFind])).SendKeysWait(searchCriteria);
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.QuickFind])).SendKeysWait(Keys.Enter);
        ...
        internal BrowserCommandResult<bool> NextPage(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.NextPage])).ClickWait();
        ...
        internal BrowserCommandResult<bool> PreviousPage(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.PreviousPage])).ClickWait();
        ...
        internal BrowserCommandResult<bool> FirstPage(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.FirstPage])).ClickWait();
        ...
        internal BrowserCommandResult<bool> SelectAll(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.SelectAll])).ClickWait();
        ...
        public BrowserCommandResult<bool> ShowChart(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Grid.ShowChart])))
                {
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.ShowChart])).ClickWait();
        ...
        public BrowserCommandResult<bool> HideChart(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Grid.HideChart])))
                {
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.HideChart])).ClickWait();
        ...
        public BrowserCommandResult<bool> SelectRecord(int index, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                var container = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Grid.RowsContainer]),
        ...
        public BrowserCommandResult<bool> SwitchChart(string chartName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.ChartSelector])).ClickWait();

                var list = driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Grid.ChartViewList]));

                driver.FindElement(By.XPath("//li[contains(@title,'" + chartName + "')]")).ClickWait();
        ...
        {
            return this.Execute(GetOptions("ClickWait Related Tab Command"), driver =>
            {
                if (!driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Related.CommandBarButton].Replace("[NAME]", name))))
                ...
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Related.CommandBarButton].Replace("[NAME]", name))).ClickWait(true);

                driver.WaitForTransaction();

                if (subName != null)
                {
                    if (!driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Related.CommandBarSubButton].Replace("[NAME]", subName))))
                        throw new NotFoundException($"{subName} button not found");

                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Related.CommandBarSubButton].Replace("[NAME]", subName))).ClickWait(true);
        ...
        internal BrowserCommandResult<bool> CancelQuickCreate(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                var save = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.QuickCreate.CancelButton]),
        ...
        internal BrowserCommandResult<bool> SaveQuickCreate(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                var save = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.QuickCreate.SaveAndCloseButton]),
        ...
        public BrowserCommandResult<bool> OpenRecordSetNavigator(int index = 0, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions("Open Record Set Navigator"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.RecordSetNavigatorOpen])))
                {
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.RecordSetNavigator])).ClickWait();
                }
        ...
        public BrowserCommandResult<bool> CloseRecordSetNavigator(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                var closeSpan =
                    driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.RecordSetNavCollapseIcon]));

                if (closeSpan)
                {
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.RecordSetNavCollapseIconParent])).ClickWait();
                }
        ...
        internal BrowserCommandResult<bool> SetValue(string field, string value)
        {
            ...
            {
                var fieldContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldContainer].Replace("[NAME]", field)));
        ...
        internal BrowserCommandResult<bool> SetValue(LookupItem control, int index = 0)
        {
            return this.Execute(GetOptions($"Set Lookup Value: {control.Name}"), driver =>
            {
                ...
                var fieldContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldLookupFieldContainer].Replace("[NAME]", control.Name)));
                ...
                if (input != null)
                {
                    ...
                    //driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldLookupSearchButton].Replace("[NAME]", control.Name))).ClickWait();
        ...
        internal BrowserCommandResult<bool> SetValue(LookupItem[] controls, int index = 0, bool clearFirst = true)
        {
            return this.Execute(GetOptions($"Set ActivityParty Lookup Value: {controls.First().Name}"), driver =>
            {
                ...
                var fieldContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldLookupFieldContainer].Replace("[NAME]", controls.First().Name)));
                ...
                input.SendKeysWait(Keys.Escape); // IE wants to keep the flyout open on multi-value fields, this makes sure it closes
        ...
        private void SetLookUpByValue(IWebDriver driver, LookupItem control, int index)
        {
            ...
            driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldLookupMenu].Replace("[NAME]", control.Name)));
         
            driver.WaitForTransaction();

            //driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.LookupFieldResultListItem].Replace("[NAME]", control.Name)));
            var lookupResultsItems = driver.WaitForElements(By.XPath($"//*[contains(@data-id, '{control.Name}.fieldControl-LookupResultsDropdown_{control.Name}_resultsContainer') and starts-with(@aria-label,'{control.Value}')]"))
                .ToList();
            ...
            var clickedElement = lookupResultsItems.First().FindElement(By.XPath("./div")).ClickWait();

            clickedElement.WaitForNotExists(TimeSpan.FromSeconds(5));
        ...
        {
            driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.LookupResultsDropdown].Replace("[NAME]", control.Name)));
            var lookupResultsDialog = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.LookupResultsDropdown].Replace("[NAME]", control.Name)));
            ...
            var clickedElement = driver.FindElement(By.Id(lookupResult.Id)).ClickWait();
        ...
        public BrowserCommandResult<bool> SetValue(OptionSet option)
        {
            ...
            {
                var fieldContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldContainer].Replace("[NAME]", option.Name)));
                ...
                else if (fieldContainer.FindElements(By.XPath(AppElements.Xpath[AppReference.Entity.EntityOptionsetStatusCombo].Replace("[NAME]", option.Name))).Count > 0)
                {
                    ...
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.EntityOptionsetStatusComboButton].Replace("[NAME]", option.Name))).ClickWait();
        ...
        public BrowserCommandResult<bool> SetValue(BooleanItem option)
        {
            return this.Execute(GetOptions($"Set BooleanItem Value: {option.Name}"), driver =>
            {
                ...
                var hasRadio = fieldContainer.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldRadioContainer].Replace("[NAME]", option.Name)));
                var hasCheckbox = fieldContainer.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldCheckbox].Replace("[NAME]", option.Name)));
                var hasList = fieldContainer.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldList].Replace("[NAME]", option.Name)));
                ...
                if (hasRadio)
                {
                    ...
                    {
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldRadioContainer].Replace("[NAME]", option.Name))).ClickWait();
                    }
                }
                else if (hasCheckbox)
                {
                    ...
                    {
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldCheckboxContainer].Replace("[NAME]", option.Name))).ClickWait();
                    }
                }
                else if (hasList)
                {
                    ...
                    if (option.Value && !trueOptionSelected || !option.Value && trueOptionSelected)
                    {
                        ...
                        {
                            driver.FindElement(By.Id(unselectedOption.GetAttribute("id"))).ClickWait();
                        }
                    }
                }
                else
        ...
        public BrowserCommandResult<bool> SetValue(string field, DateTime date, string format = "M/d/yyyy h:mm tt")
        {
            return this.Execute(GetOptions($"Set Value: {field}"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(dateField)))
                {
                    var fieldElement = driver.FindElement(By.XPath(dateField)).ClickWait();
                    fieldElement.ClickWait();
                    if (fieldElement.GetAttribute("value").Length > 0)
                    {
                        fieldElement.SendKeysWait(Keys.Control + "a");
                        fieldElement.SendKeysWait(Keys.Backspace);
                    ...
                    fieldElement.SendKeysWait(date.ToString(format));
        ...
        private BrowserCommandResult<bool> RemoveMultiOptions(MultiValueOptionSet option)
        {
            return this.Execute(GetOptions($"Remove Multi Select Value: {option.Name}"), driver =>
            {
                ...
                {
                    expandCollapseButtons.First().ClickWait(true);
                }

                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.MultiSelect.InputSearch].Replace("[NAME]", Elements.ElementId[option.Name]))).ClickWait();
                foreach (var optionValue in option.Values)
                {
                    ...
                    for (int i = 0; i < loopCounts; i++)
                    {
                        ...
                        driver.FindElements(By.XPath(xpath)).First().ClickWait(true);
                    }
                }
                return true;
            });
        ...
        private BrowserCommandResult<bool> AddMultiOptions(MultiValueOptionSet option)
        {
            return this.Execute(GetOptions($"Add Multi Select Value: {option.Name}"), driver =>
            {
                ...
                foreach (var optionValue in option.Values)
                {
                    ...
                    if (flyout.Any())
                    {
                        flyout.First().ClickWait(true);
                    }
                }

                // ClickWait on the div containing textbox so that the floyout collapses or else the flyout
                // will interfere in finding the next multiselect control which by chance will be lying
                // behind the flyout control.
                //driver.FindElement(By.XPath(AppElements.Xpath[AppReference.MultiSelect.DivContainer].Replace("[NAME]", Elements.ElementId[option.Name]))).ClickWait();
                ...
                if (divElements.Any())
                {
                    divElements.First().ClickWait(true);
                }
                return true;
            });
        }
        ...
        internal BrowserCommandResult<Field> GetField(string field)
        {
            ...
            {
                Field returnField = new Field(driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldContainer].Replace("[NAME]", field))));
        ...
        internal BrowserCommandResult<bool> GetValue(BooleanItem option)
        {
            return this.Execute($"Get BooleanItem Value: {option.Name}", driver =>
            {
                ...
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldContainer].Replace("[NAME]", option.Name) + "//*[contains(@data-id,'checkbox')]"));
                var hasRadio = fieldContainer.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldRadioContainer].Replace("[NAME]", option.Name)));
                var hasCheckbox = fieldContainer.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldCheckbox].Replace("[NAME]", option.Name)));
                var hasList = fieldContainer.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityBooleanFieldList].Replace("[NAME]", option.Name)));
        ...
        internal BrowserCommandResult<List<GridItem>> GetSubGridItems(string subgridName)
        {
            return this.Execute(GetOptions($"Get Subgrid Items for Subgrid {subgridName}"), driver =>
            {
                ...
                if (!driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.SubGridTitle].Replace("[NAME]", subgridName))))
        ...
        /// <summary>
        /// ClickWait the magnifying glass icon for the lookup control supplied
        /// </summary>
        ...
        internal BrowserCommandResult<bool> SelectLookup(LookupItem control)
        {
            ...
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.FieldLookupButton].Replace("[NAME]", control.Name))))
                {
                    ...
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.SearchButtonIcon])).ClickWait(true);
                }
                else
        ...
        internal BrowserCommandResult<string> GetHeaderValue(LookupItem control)
        {
            ...
            {
                if (!driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityHeader])))
        ...
        internal BrowserCommandResult<string> GetStatusFromFooter()
        {
            ...
            {
                if (!driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.EntityFooter])))
        ...
        internal BrowserCommandResult<bool> ClearValue(LookupItem control, bool removeAll = true)
        {
            return this.Execute(GetOptions($"Clear Field {control.Name}"), driver =>
            {
                ...
                {
                    if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Entity.LookupFieldHoverExistingValue].Replace("[NAME]", control.Name))))
                    {
                        ...
                        existingList.SendKeysWait(Keys.Clear);
                    }
                }
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TextFieldLookupSearchButton].Replace("[NAME]", control.Name)));
                ...
                if (removeAll)
                {
                    ...
                    {
                        driver.FindElement(By.Id(existingValues.First().GetAttribute("id"))).ClickWait();
                        existingValues = fieldContainer.FindElements(By.XPath(AppElements.Xpath[AppReference.Entity.LookupFieldDeleteExistingValue].Replace("[NAME]", control.Name)));
                    }
                }
                else
                {
                    ...
                    if (control.Value != null && control.Value != "")
                    {
                        foreach (var existingValue in existingValues)
                        {
                            ...
                            {
                                driver.FindElement(By.Id(existingValue.GetAttribute("id"))).ClickWait();
                                return true;
                            }
                        }
                    ...
                    else if (control.Value == "")
                    {
                        ...
                        driver.FindElement(By.Id(existingValues[control.Index].GetAttribute("id"))).ClickWait();
                    }
                    else if (control.Value == null)
                    {
        ...
        internal BrowserCommandResult<bool> SelectForm(string formName)
        {
            return this.Execute(GetOptions($"Select Form {formName}"), driver =>
            {
                ...
                if (!driver.ElementExists(By.XPath(Elements.Xpath[Reference.Entity.FormSelector])))
                    throw new NotFoundException("Unable to find form selector on the form");

                var formSelector = driver.WaitForElement(By.XPath(Elements.Xpath[Reference.Entity.FormSelector]));
                // ClickWait didn't work with IE
                formSelector.SendKeysWait(Keys.Enter);

                driver.WaitForElement(By.XPath(Elements.Xpath[Reference.Entity.FormSelectorFlyout]));
                ...
                driver.FindElement(By.Id(form.GetAttribute("id"))).ClickWait();
        ...
        internal BrowserCommandResult<bool> OpenLookupRecord(int index)
        {
            ...
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Lookup.LookupResultRows])))
                {
                    var rows = driver.FindElements(By.XPath(AppElements.Xpath[AppReference.Lookup.LookupResultRows]));

                    if (rows.Count > 0)
                        rows.FirstOrDefault().ClickWait(true);
                }
                else
        ...
        internal BrowserCommandResult<bool> SearchLookupField(LookupItem control, string searchCriteria)
        {
            ...
            {
                //ClickWait in the field and enter values
        ...
        {
            //ClickWait the Related Entity on the Lookup Flyout
            return this.Execute(GetOptions($"Select Lookup Related Entity {entityName}"), driver =>
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Lookup.RelatedEntityLabel].Replace("[NAME]", entityName))))
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Lookup.RelatedEntityLabel].Replace("[NAME]", entityName))).ClickWait(true);
                else
        ...
        internal BrowserCommandResult<bool> SwitchLookupView(string viewName)
        {
            ...
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Lookup.ChangeViewButton])))
                {
                    //ClickWait Change View 
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Lookup.ChangeViewButton])).ClickWait(true);

                    driver.WaitForTransaction();

                    //ClickWait View Requested 
                    ...
                    if (rows.Any(x => x.Text.Equals(viewName, StringComparison.OrdinalIgnoreCase)))
                        rows.First(x => x.Text.Equals(viewName, StringComparison.OrdinalIgnoreCase)).ClickWait(true);
                    else
        ...
        {
            return this.Execute(GetOptions("ClickWait New Lookup Button"), driver =>
            {
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.Lookup.NewButton])))
                {
                    ...
                    if (newButton.GetAttribute("disabled") == null)
                        driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Lookup.NewButton])).ClickWait();
                    else
        ...
        internal BrowserCommandResult<bool> OpenAndClickPopoutMenu(By menuName, By menuItemName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.FindElement(menuName).ClickWait();
                try
                {
                    driver.FindElement(menuItemName).ClickWait();
                }
                catch
                {
        ...
        internal BrowserCommandResult<bool> Delete(int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                var deleteBtn = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.Delete]),
    "Delete Button is not available");
        ...
        {
            //ClickWait the Assign Button on the Entity Record
            this.Browser.ThinkTime(thinkTime);

            return this.Execute(GetOptions($"Assign Entity"), driver =>
            {
                var assignBtn = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.Assign]),
        ...
        internal BrowserCommandResult<bool> SwitchProcess(string processToSwitchTo, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.ProcessButton]), new TimeSpan(0, 0, 5));
                var processBtn = driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.ProcessButton]));
                processBtn?.ClickWait();
                ...
                try
                {
                    driver.WaitForElement(
                        ...
                        new TimeSpan(0, 0, 5),
                        d => { driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Entity.SwitchProcess])).ClickWait(); },
        ...
        internal BrowserCommandResult<bool> CloseOpportunity(bool closeAsWon, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                var closeBtn = driver.WaitForElement(By.XPath(xPathQuery), "Opportunity Close Button is not available");

                closeBtn?.ClickWait();
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.CloseOpportunity.Ok]));
        ...
        internal BrowserCommandResult<bool> CloseOpportunity(double revenue, DateTime closeDate, string description, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Close Opportunity"), driver =>
            {
                ...
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.CloseOpportunity.Ok]),
                    new TimeSpan(0, 0, 5),
                    d => { driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Dialogs.CloseOpportunity.Ok])).ClickWait(); },
                    d => { throw new InvalidOperationException("The Close Opportunity dialog is not available."); });
        ...
        internal BrowserCommandResult<bool> ClickButton(By by)
        {
            ...
            {
                var button = driver.WaitForElement(by);
                if (button.TagName.Equals("button"))
                {
                    try
                    {
                        driver.FindElement(by).ClickWait();
                    }
                    catch
                    {
                        // Element is stale reference is thrown here since the HTML components 
                ...
                {
                    button.FindElements(By.TagName("button")).First().ClickWait();
                    return true;
                }
                else
                {
        ...
        internal BrowserCommandResult<bool> SelectTab(string tabName, string subTabName = "", int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                IWebElement tabList = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.Entity.TabList]));

                ClickTab(tabList, AppElements.Xpath[AppReference.Entity.Tab], tabName);

                //ClickWait Sub Tab if provided
        ...
        internal void ClickTab(IWebElement tabList, string xpath, string name)
        {
            ...
            if(tabList.ElementExists(By.XPath(string.Format(xpath, name))))
            {
                searchScope = tabList;
        ...
        internal BrowserCommandResult<bool> SetValue(string fieldName, string value, string expectedTagName)
        {
            ...
            {
                var inputbox = driver.WaitForElement(By.XPath(Elements.Xpath[fieldName]));
                if (expectedTagName.Equals(inputbox.TagName, StringComparison.InvariantCultureIgnoreCase))
                {
                    inputbox.ClickWait();
                    inputbox.Clear();
                    inputbox.SendKeysWait(value);
                    return true;
                }
                else
                {
        ...
        internal BrowserCommandResult<bool> BPFSetValue(string field, string value)
        {
            ...
            {
                var fieldContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.TextFieldContainer].Replace("[NAME]", field)));
                ...
                {
                    fieldContainer.FindElement(By.TagName("textarea")).ClickWait();
                    fieldContainer.FindElement(By.TagName("textarea")).Clear();
                    fieldContainer.FindElement(By.TagName("textarea")).SendKeysWait(value);
                }
                else
                {
                    throw new Exception($"Field with name {field} does not exist.");
        ...
        public BrowserCommandResult<bool> BPFSetValue(BooleanItem option)
        {
            return this.Execute(GetOptions($"Set BPF Value: {option.Name}"), driver =>
            {
                var fieldContainer = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.BooleanFieldContainer].Replace("[NAME]", option.Name)));
                if (!option.Value)
                {
            ...
            return this.Execute(GetOptions($"Set BPF Value: {field}"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(dateField)))
                {
                    ...
                    if (fieldElement.GetAttribute("value").Length > 0)
                    {
                        ...
                        fieldElement.SendKeysWait(Keys.Backspace);
                        this.Browser.ThinkTime(250);
                        fieldElement.SendKeysWait(date.ToString(format), true);
        ...
        internal BrowserCommandResult<bool> NextStage(string stageName, Field businessProcessFlowField = null, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Next Stage"), driver =>
            {
                ...
                foreach (var processStage in processStages)
                {
                    ...
                    //ClickWait the Label of the Process Stage if found
                    foreach (var label in labels)
                    {
                ...
                foreach (var control in flyoutFooterControls)
                {
                    ...
                    if (businessProcessFlowField != null)
                    {
                        ...
                        if (bpfField != null)
                        {
                            ...
                            {
                                bpfField.SendKeysWait(businessProcessFlowField.Value.Substring(i, 1));
                            }
                        }
                    }

                    //ClickWait the Next Stage Button
                    var nextButton = control.FindElement(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.NextStageButton]));
                    nextButton.ClickWait();
                }
        ...
        internal BrowserCommandResult<bool> SetActive(string stageName = "", int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Set Active Stage: {stageName}"), driver =>
            {
                if (!String.IsNullOrEmpty(stageName))
                {
                    ...
                    if (!driver.ElementExists(By.XPath("//button[contains(@data-id,'setActiveButton')]")))
                        throw new NotFoundException($"Unable to find the Set Active button. Please verify the stage name { stageName } is correct.");

                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.SetActiveButton])).ClickWait(true);
        ...
        internal BrowserCommandResult<bool> BPFPin(string stageName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                //ClickWait the BPF Stage
                SelectStage(stageName, 0);
                driver.WaitForTransaction();

                //Pin the Stage
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.PinStageButton])))
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.PinStageButton])).ClickWait();
                else
        ...
        internal BrowserCommandResult<bool> BPFClose(string stageName, int thinkTime = Constants.DefaultThinkTime)
        {
            return this.Execute(GetOptions($"Close BPF: {stageName}"), driver =>
            {
                ...
                //Pin the Stage
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.CloseStageButton])))
                    driver.FindElement(By.XPath(AppElements.Xpath[AppReference.BusinessProcessFlow.CloseStageButton])).ClickWait(true);
                else
        ...
        internal BrowserCommandResult<bool> GlobalSearch(string criteria, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Global Search: {criteria}"), driver =>
            {
                ...
                if (driver.ElementExists(By.XPath(AppElements.Xpath[AppReference.GlobalSearch.Text])))
                {
                    var searchType = driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.GlobalSearch.Type])).GetAttribute("value");
                    ...
                    {
                        input.SendKeysWait(criteria, true);
                        button.ClickWait(true);
                    }
                    else
                    {
        ...
        public BrowserCommandResult<bool> FilterWith(string entity, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.GlobalSearch.Filter]), 
                                        new TimeSpan(0, 0, 10),
                                        e => {
        ...
        public BrowserCommandResult<bool> Filter(string filterBy, string value, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.GlobalSearch.GroupContainer].Replace("[NAME]", filterBy)),
                                        new TimeSpan(0, 0, 10),
                                        e => {
        ...
        public BrowserCommandResult<bool> OpenGlobalSearchRecord(string entity, int index, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            return this.Execute(GetOptions($"Open Global Search Record"), driver =>
            {
                ...
                if (searchType == "1") //Categorized Search
                {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.GlobalSearch.Container]),
        ...
        public BrowserCommandResult<bool> ChangeSearchType(string type, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                driver.WaitForElement(By.XPath(AppElements.Xpath[AppReference.GlobalSearch.Type]),
                                        Constants.DefaultTimeout,
                                        c=> {
                                            ...
                                            if(option!=null)
                                            {
                                                select.ClickWait(true);
                                                option.ClickWait(true);
                                            } 
        ...
        internal BrowserCommandResult<bool> SelectDashboard(string dashboardName, int thinkTime = Constants.DefaultThinkTime)
        {
            ...
            {
                //ClickWait the drop-down arrow
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Dashboard.DashboardSelector])).ClickWait();;
                //Select the dashboard
                driver.FindElement(By.XPath(AppElements.Xpath[AppReference.Dashboard.DashboardItemUCI].Replace("[NAME]", dashboardName))).ClickWait();;
