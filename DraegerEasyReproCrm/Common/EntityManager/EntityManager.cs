...
namespace Draeger.Dynamics365.Testautomation.Common.EntityManager
{
    ...
    public class BaseComponent : EntityManagerComponent
    {
        ...
        public override Entity CreateEntityRecord<T>(object caller, T entity)
        {
                ...
                Logger.Information("{informationDescription} {Entity} with name {defaultPrefix}",
                    InformationDescription, entity.LogicalName, this.DefaultPrefix);
                return GetEntityRecord(this, entity.LogicalName, context.Create(entity));
